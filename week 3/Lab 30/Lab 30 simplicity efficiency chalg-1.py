...
#your code here
'''
1) the calculator is based on string and operate each case figure one by one. by operating integers instead, simplicity can be achieved by leveraging python calculation capabilities
2) to reduce the number of cases, we should first ask for the type of operation 

'''
print('''Welcome to this calculator! It can add or subtract whole numbers from 0 to 5''')
a = input('What do you want to do? + or - :')
b = input('Please choose your first number between zero to five: ')
c = input('Please choose your second number between zero to five: ')
numbers = {'zero':0,'one':1,'two':2,'three':3,'four':4,'five':5}
results = {0:'zero',1:'one',2:'two',3:'three',4:'four',5:'five',6:'six',7:'seven',8:'eight',9:'nine',10:'ten',-1:'minus one',-2:'minus two',-3:'minus three',-4:'minus four',-5:'minus five'}
if (a != '+' and a != '-') or numbers.get(b) == None or numbers.get(c) == None :
    print ("I am not able to answer this question. Check your input.")
#elif numbers.get(b) == None or numbers.get(c) == None:
#    print ("I am not able to answer this question. Check your input.")
else:
    if a == '+':
        print(b,'+', c, '=', results[numbers[b]+numbers[c]])
    else:
        print(b,'-', c, '=', results[numbers[b]-numbers[c]])
print("Thanks for using this calculator, goodbye :)")
